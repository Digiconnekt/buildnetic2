              ...
              <div className="row">
                <div className=" col-xs-12 col-sm-6">
                  <p style={{ lineHeight: "1.7" }}>
                    Buildnetic serves as a powerful tool for your
                    digitalization, changing your visualization into genuine
                    business innovation and increasing the rate at which
                    customers convert into paying customers. We are prepared to
                    assist you with our expertise!
                  </p>
                  <p style={{ lineHeight: "1.7" }}>
                    Our expertise combines brand creation, analytics, and
                    consulting expertise to help you effectively identify client
                ...
                <div className=" col-xs-12 col-sm-6">
                  ...
                  <p style={{ lineHeight: "1.7" }}>
                    ...
                    strategies and incorporating new technologies to promote
                    digital excellence, we seek to broaden your brand's
                    recognition across dimensions, boost client engagement, and
                    maximize ROI.
                  </p>
                </div>
              </div>
                ...
                <div className=" col-xs-12 col-sm-4">
                  <div className="team-item">
                    <div className="team-item__wrap">
                      <img
                        alt="Sachin Bansal"
                        data-src="//steadyrabbit.in/sr/wp-content/uploads/2021/01/TD4.png"
                        className="team-item__img lazyload"
                        src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                      />
                      <noscript>
                        <img
                          src="//steadyrabbit.in/sr/wp-content/uploads/2021/01/TD4.png"
                          alt="Sachin Bansal"
                      ...
                      <div className="team-item-social">
                        <a
                          ...
                          target="_blank"
                          href="https://www.linkedin.com/in/bansalsachin/"
                        >
                          <i className="ico ico-104 team-item-social__icon"></i>
                        </a>
                      </div>
                    </div>
                    <div className="team-item-details">
                      ...
                      <div className="team-item-details__position">CEO</div>
                    </div>
                  </div>
                </div>
                <div className=" col-xs-12 col-sm-4">
                  <div className="team-item">
                    <div className="team-item__wrap">
                      <img
                        alt="Mudit"
                        data-src="//steadyrabbit.in/sr/wp-content/uploads/2021/01/mudit-agrwal.png"
                        className="team-item__img lazyload"
                        src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                      />
                      <noscript>
                        <img
                          src="//steadyrabbit.in/sr/wp-content/uploads/2021/01/mudit-agrwal.png"
                          alt="Mudit"
                          className="team-item__img"
                        />
                      </noscript>
                      <div className="team-item-social">
                        <a
                          className="team-item-social__link"
                          target="_blank"
                          href="https://www.linkedin.com/in/mudit-aggarwal/"
                        >
                          <i className="ico ico-104 team-item-social__icon"></i>
                        </a>
                      </div>
                    ...
                    <div className="team-item-details">
                      ...
                      <div className="team-item-details__position">COO</div>
                    </div>
                  </div>
                </div>
                <div className=" col-xs-12 col-sm-4">
                  <div className="team-item">
                    <div className="team-item__wrap">
                      <img
                        alt="Amit Sharma"
                        data-src="//steadyrabbit.in/wp-content/uploads/2022/03/Amit-Sharma.png"
                        className="team-item__img lazyload"
                        src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                      />
                      <noscript>
                        <img
                          src="//steadyrabbit.in/wp-content/uploads/2022/03/Amit-Sharma.png"
                          alt="Amit Sharma"
                          className="team-item__img"
                        />
                      </noscript>
                      <div className="team-item-social">
                        <a
                          className="team-item-social__link"
                          target="_blank"
                          href="https://www.linkedin.com/in/amit-sharma-374109192/"
                        >
                          <i className="dashicons dashicons-linkedin team-item-social__icon"></i>
                        </a>
                      </div>
                    </div>
                    <div className="team-item-details">
                      <div className="team-item-details__name">Amit Sharma</div>
