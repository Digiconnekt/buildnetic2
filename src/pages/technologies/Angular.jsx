            ...
            <div className="hero">
              <div className="container hero-section">
                ...
                <div className="right-block">
                  <img
                    src="../assets/images/services/service.png"
                    alt="Angular"
                  />
                </div>
              </div>
                  ...
                  >
                    <div className="info-box-item__inner">
                      <div className="info-box__description">
                        ...
                        <p>
                          A cutting-edge web development platform and
                          application design framework for building effective
                          single-page apps is called Angular. Built with a
                          variety of capabilities on TypeScript, it facilitates
                          the creation of complicated single-page enterprise
                          apps as well as scalable online applications. Faster
                          performance, scalable development, and a contemporary
                          approach to web application worldwide deployment are
                          all guaranteed by Angular.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="info-box-item__inner">
                      <div className="info-box-2-subitem">
                        <div className="info-box-2-subitem__description">
                          ...
                          <p style={{ marginLeft: "0px", marginTop: "-24px" }}>
                            A technique for creating cross-platform
                            applications.
                          </p>
                        </div>
                      </div>
                      <div className="info-box-2-subitem">
                        <div className="info-box-2-subitem__description">
                          ...
                          <p style={{ marginLeft: "0px", marginTop: "-24px" }}>
                            Scalable on web platforms at the fastest possible
                            rate.
                          </p>
                        </div>
                      </div>
                      <div className="info-box-2-subitem">
                        <div className="info-box-2-subitem__description">
                          ...
                          <p style={{ marginLeft: "0px", marginTop: "-24px" }}>
                            Prebuilt templates make it simple to develop
                            features.
                          </p>
                        </div>
                      </div>
                      <div className="info-box-2-subitem">
                        <div className="info-box-2-subitem__description">
                          ...
                          <p style={{ marginLeft: "0px", marginTop: "-24px" }}>
                            Support for global deployment development.
                          </p>
                        </div>
                      </div>
                      <div className="info-box-2-subitem">
                        <div className="info-box-2-subitem__description">
                          ...
                          <p style={{ marginLeft: "0px", marginTop: "-24px" }}>
                            Zero-step installation and high performance.
                          </p>
                        </div>
                      </div>
                    </div>
          ...
          <section className="section section-white section-2" id="service111">
            ...
            <div className="container align-left">
              <div className="row equal-cols-container">
                <div
                  className=" col-xs-12 col-sm-6 col-md-6 col-lg-6 equal-cols"
                  // style={{ height: "221px" }}
                >
                  <div
                    ...
                    <div className="features-item__text">
                      <h5>
                        <a
                          ...
                          style={{ color: "#0a0039 " }}
                        >
                          UI/UX Development for Angular
                        </a>
                      </h5>
                      <p style={{ marginBottom: "5%", textAlign: "justify" }}>
                        While reusing the codes, create, design, and convert
                        complex design components. We support the creation of
                        UX/UI design for faster installation and higher
                        performance.
                      </p>
                    </div>
                  </div>
                </div>
                <div className=" col-xs-12 col-sm-6 col-md-6 col-lg-6 equal-cols">
                  <div
                    className="features-item"
                    style={{ textAlign: "center" }}
                  >
                    ...
                    <div className="features-item__text">
                      ...
                      <p style={{ marginBottom: "5%", textAlign: "justify" }}>
                        With the assistance of our team of professionals,
                        customise your web development to meet your business
                        objectives. We assist in offering quicker, more
                        effective, and uncompromising solutions.
                      </p>
                    </div>
                  </div>
                </div>
                <div className=" col-xs-12 col-sm-6 col-md-6 col-lg-6 equal-cols">
                  ...
                  >
                    ...
                    <div className="features-item__text">
                      ...
                      <p style={{ marginBottom: "5%", textAlign: "justify" }}>
                        For efficient operations, we offer maintenance and
                        support services. In addition to speed optimization, we
                        also offer security updates, plugin updates, version
                        upgrades, etc.
                      </p>
                    </div>
                  </div>
