    ...
    <>
      <div className="wrapper-content" style={{ marginBottom: "527.6px" }}>
        <div className="fw-page-builder-content">
          {/* title start */}
          <div class="section hidden-xs section-2" style={{ height: "650px" }}>
            <div class=" align-left">
              ...
              >
                <div class="pro-items">
                  <div class="main-1-item parallax-wrapper pro-item pro-item_active">
                    <div
                      class="parallax"
                      style={{
                        backgroundImage:
                    ...
                    <div class="pro-item__timeline"></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div
            class="section hidden-sm hidden-md hidden-lg section-2"
            id="slider-mob"
            style={{ height: "650px" }}
          >
            <div class=" align-left">
            ...
            <div class="container align-left">
              <div class="row">
                <div class="col-xs-12 col-sm-12">
                  <h3 class="section__title">Our Service Offerings</h3>
                </div>
              </div>
            </div>

            <div class="container align-left">
              <div class="row equal-cols-container">
                <div
                ...
                >
                  <div class="features-item" style={{ textAlign: "center" }}>
                    <img
                      ...
                      class="features-item__icon  ls-is-cached lazyloaded"
                    ...
                    <div class="features-item__text">
                      ...
                      <p style={{ marginBottom: "5%", textAlign: "justify" }}>
                        ...
                        search page, therefore increasing the engagement of the
                        viewers.
                      </p>
                    </div>
                  </div>
                ...
                <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4 equal-cols">
                  <div class="features-item" style={{ textAlign: "center" }}>
                    <img
                      ...
                      class="features-item__icon  lazyloaded"
                    ...
                    <div class="features-item__text">
                      ...
                      <p style={{ marginBottom: "5%", textAlign: "justify" }}>
                        ...
                        promise you an increase in your potential customers.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="features-item" style={{ textAlign: "center" }}>
                    ...
                    <div class="features-item__text">
                      ...
                      <p style={{ marginBottom: "5%", textAlign: "justify" }}>
                        ...
                        automatically generate traffic. To start with, blend
          ...
          {/* services offering end */}

          {/* question our competence start */}
          <div
            class="section hidden-xs section-lightgray"
            id="cta"
            style={{
              backgroundImage:
          ...
          <div
            class="section hidden-sm hidden-md hidden-lg section-lightgray pt-0 pb-0"
            id="cta_mob"
          >
          ...
          {/* testimonial start */}
          <section
            class="section section-lightgray section-2"
            id="testimonials"
          >
            <div class="container align-left">
              <div class="row">
			...
			#sp-testimonial-free-wrapper-3455 .sp-testimonial-free-section{
                  ...
                  >
                    <div
                      ...
                      class="sp-testimonial-free-section tfree-style-theme-one slick-initialized slick-slider slick-dotted"
                      dir="ltr"
                    ...
                    >
                      ...
                      <div aria-live="polite" class="slick-list draggable">
                        ...
                        >
                          <div
                            class="sp-testimonial-free-item slick-slide slick-cloned"
                            data-slick-index="-1"
                            id=""
                            aria-hidden="true"
                            style={{ width: "1094px" }}
                          ...
                          >
                            <div class="sp-testimonial-free">
                              <div class="sp-tfree-client-image">
                                <img
                                  width="120"
                                  height="120"
                                  alt="Ram"
                                  ...
                                  class="tfree-client-image wp-post-image ls-is-cached lazyloaded"
                              ...
                              <div class="tfree-testimonial-title">
                                <h3>Ram Niwas</h3>
                              </div>
                              <div class="tfree-client-testimonial">
                                <p class="tfree-testimonial-content"></p>
                                <p
                                  style={{
                                    color: "#000000",
                                  }}
                              ...
                              <h4 class="tfree-client-name">Director</h4>
                              ...
                              <div class="tfree-client-designation">
                                A-One Software
                              </div>
                            </div>
                          </div>
                          <div
                            class="sp-testimonial-free-item slick-slide slick-current slick-active"
                            data-slick-index="0"
                            aria-hidden="false"
                            style={{ width: "1094px" }}
                            tabindex="-1"
                            ...
                            <div class="sp-testimonial-free">
                              <div class="sp-tfree-client-image">
                                <img
                                  ...
                                  data-sizes="(max-width: 120px) 100vw, 120px"
                                  class="tfree-client-image wp-post-image lazyloaded"
                          ...
                          <div
                            class="sp-testimonial-free-item slick-slide"
                            data-slick-index="1"
                            aria-hidden="true"
                            style={{ width: "1094px" }}
                            tabindex="-1"
