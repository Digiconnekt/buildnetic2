            ...
            <div className="hero">
              <div className="container hero-section">
                <div className="left-block">
                  ...
                  >
                    <span style={{ color: "#fff" }}>Most Scalable Tool:</span>{" "}
                    <br />
                    ReactJs
                  </h1>
                </div>
                  ...
                  >
                    <div className="info-box-item__inner">
                      <div className="info-box__description">
                        ...
                        <p>
                          ReactJS is an open-source JavaScript library framework
                          used to create incredibly interactive user interfaces
                          for websites and other applications. Its dynamic UIs
                          are groundbreaking for web development since they are
                          rapidly responsive and constantly evolving. ReactJS is
                          a time-saving and programming-friendly paradigm since
                    ...
                    <div className="info-box-item__inner">
                      <div className="info-box-2-subitem">
                        <div className="info-box-2-subitem__description">
                          ...
                          <p style={{ marginLeft: "0px", marginTop: "-24px" }}>
                            High-quality user experience with UI.
                          </p>
                        </div>
                      </div>
                      <div className="info-box-2-subitem">
                        <div className="info-box-2-subitem__description">
                          ...
                          <p style={{ marginLeft: "0px", marginTop: "-24px" }}>
                            Rapid adaptability and modernization.
                          </p>
                        </div>
                      </div>
                      <div className="info-box-2-subitem">
                        <div className="info-box-2-subitem__description">
                          ...
                          <p style={{ marginLeft: "0px", marginTop: "-24px" }}>
                            Accurate and user-friendly programming for
                            developers.
                          </p>
                        </div>
                      </div>
                      <div className="info-box-2-subitem">
                        <div className="info-box-2-subitem__description">
                          ...
                          <p style={{ marginLeft: "0px", marginTop: "-24px" }}>
                            Most complicated programming is simplified.
                          </p>
                        </div>
                      </div>
                      <div className="info-box-2-subitem">
                        <div className="info-box-2-subitem__description">
                          ...
                          <p style={{ marginLeft: "0px", marginTop: "-24px" }}>
                            Improved efficiency and easy maintenance.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    ...
                    <div className="features-item__text">
                      ...
                      <p style={{ marginBottom: "5%", textAlign: "justify" }}>
                        Utilize React's robust libraries to transform your
                        concept into a beautiful UI/UX.
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="features-item__text">
                      <h5>
                        <a
                          ...
                          style={{ color: "#0a0039 " }}
                        >
                          Maintenance and Support for React.js
                        </a>
                      </h5>
                      <p style={{ marginBottom: "5%", textAlign: "justify" }}>
                        Make updating existing features and adding new ones
                        simple. No matter what state your project may be in, our
                        staff will effortlessly create and maintain it.
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="features-item__text">
                      <h5>
                        <a
                          ...
                          style={{ color: "#0a0039 " }}
                        >
                          Testing the React.js Quality
                        </a>
                      </h5>
                      <p style={{ marginBottom: "5%", textAlign: "justify" }}>
                        Test each design element you created with ReactJs. To
                        guarantee that your solutions operate without a hitch,
                        we develop a thorough testing strategy.
                      </p>
                    </div>
                  </div>
                </div>
