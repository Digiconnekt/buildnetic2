                  ...
                  >
                    <div class="info-box-item__inner">
                      <div class="info-box__description">
                        ...
                        <p>
                          It is a process of examining and evaluating software
                          with the goal of identifying errors and discrepancies
                          between the requirements that were generated and those
                          that were actually needed. It aids in preserving the
                          software's quality.
                        </p>
                      </div>
                    </div>
                      ...
                      <div class="info-box-2-subitem">
                        <div class="info-box-2-subitem__description">
                          ...
                          <p style={{ marginLeft: "0px", marginTop: "-24px" }}>
                            We aid in the creation of high-quality products
                          </p>
                        </div>
                      </div>
                      <div class="info-box-2-subitem">
                        <div class="info-box-2-subitem__description">
                          ...
                          <p style={{ marginLeft: "0px", marginTop: "-24px" }}>
                            By removing bugs we serve great user experience
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              <div class="row">
                <div class="col-xs-12 col-sm-6 equal-cols">
                  <div class="features-item" style={{ textAlign: "center" }}>
                    ...
                    <div class="features-item__text">
                      <p>
                        We aid in assessing a system's responsiveness,
                        stability, and speed when tested under various loads.
                        This aids in clearing performance bottlenecks.
                      </p>
                    </div>
                  </div>
                </div>
                <div class="col-xs-12 col-sm-6 equal-cols">
                  <div class="features-item" style={{ textAlign: "center" }}>
                    ...
                    <div class="features-item__text">
                      <p>
                        By performing the software tests for mobile applications
                        on the cloud, we increase the scalability and agility of
                        your mobile testing. Simulations of cloud environments
                ...
                <div class="col-xs-12 col-sm-6 equal-cols">
                  <div class="features-item" style={{ textAlign: "center" }}>
                    ...
                    <div class="features-item__text">
                      <p>
                        Robustness is ensured by thorough testing. Web and
                        mobile testing, load and performance testing, A/B
                        testing, and security testing are all areas in which our
                        testing team excels.
                      </p>
                    </div>
                  </div>
                ...
                <div class="col-xs-12 col-sm-6 equal-cols">
                  <div class="features-item" style={{ textAlign: "center" }}>
                    ...
                    <div class="features-item__text">
                      <p>
                        To increase the quality of software, we run automated
                        tests and collect data using specialised tools. It is
                        essential for continuous testing and delivery.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-4 equal-cols no-padding">
                  ...
                  >
                    <div class="info-box-item__inner">
                      ...
                      >
                        Website Development Technical Expertise
                      </h5>
                    </div>
                  </div>
                </div>
